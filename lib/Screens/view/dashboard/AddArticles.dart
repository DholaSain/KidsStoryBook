...
class _AddArticlesState extends State<AddArticles> {
  ...
  String articleTitle, autherName, id, imageUrl;

  createData() {
    print(selectedCategory);
    if (articleTitle != null) {
      DocumentReference documentReference =
          FirebaseFirestore.instance.collection("Articles").doc(articleTitle);
  ...
  updateData() {
    if (articleTitle != null) {
      ...
      documentReference
          .set(students)
          .whenComplete(() => {print("$articleTitle document Updated")});
    }
  }
  ...
  deleteData(String data) {
    if (articleTitle != null) {
      DocumentReference documentReference =
          FirebaseFirestore.instance.collection("Articles").doc(data);
      documentReference
          .delete()
          .whenComplete(() => {print("$articleTitle document Deleted")});
    }
  }

  getArticleTitle(name) {
